...
User.create!([
  {email: "test@example.org", encrypted_password: "$2a$12$huZndTk8w7Y2ya9OjjUr0ut8ZClHk4gEFFOS1GkVSEADku2QAQ0yq", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil},
  {email: "test2@example.org", encrypted_password: "$2a$12$tDb//4fBi6YjG2JGKbgsmOISXP.OxxVAd627LtJfKFMXrE2bz4zxa", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil}
])
Assessment.create!([
...
Course.create!([
  {title: "Computer Science", year: 2020},
  {title: "Aerospace Engineering", year: 2020},
  {title: "Economics", year: 2020}
])
Enrollment.create!([
...
Role.create!([
  ...
  {name: "student", resource_type: nil, resource_id: nil}
])
Subject.create!([
